(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["TX_SHARE"] = factory();
	else
		root["TX_SHARE"] = factory();
})(window, function() {
              ...
              (0, _overWrite.default)(master.api, {
                ...
                setShareInfo: function setShareInfo(s, callback) {
                  ...
                  initShare({
                    ...
                    return master.shareCallback(data, 'qmusic');
                  });
                },
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              shareLinkAux = function shareLinkAux(client, source) {
                ...
                window.mqq.ui.shareMessage({
                  ...
                  return master.shareCallback(data, source);
                });
              };

              shareImgAux = function shareImgAux(cmd, source) {
              ...
              (0, _overWrite.default)(master.api, {
                ...
                setShareInfo: function setShareInfo(s, callback) {
                  ...
                  window.mqq.invoke('data', 'setShareInfo', {
                    ...
                    return window.mqq.ui.setOnShareHandler(function (type) {
                      shareLinkAux(type, ['qq', 'qzone', 'weixin', 'timeLine', 'weibo'][type]);
                    });
                  });
                },
                share2qq: function share2qq(_) {
                  return master.shareInfo.type === 'base64' ? shareImgAux('0', 'qq') : shareLinkAux(0, 'qq');
                },
                share2qz: function share2qz(_) {
                  return master.shareInfo.type === 'base64' ? shareImgAux('1', 'qzone') : shareLinkAux(1, 'qzone');
                },
                share2wx: function share2wx(_) {
                  return master.shareInfo.type === 'base64' ? shareImgAux('2', 'weixin') : shareLinkAux(2, 'weixin');
                },
                share2timeLine: function share2timeLine(_) {
                  return master.shareInfo.type === 'base64' ? shareImgAux('3', 'timeLine') : shareLinkAux(3, 'timeLine');
                }
              });
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              shareLinkAux = function shareLinkAux(cmd, source) {
                var sinfo = master.shareInfo;
              ...
              (0, _overWrite.default)(master.api, {
                ...
                setShareInfo: function setShareInfo(s, callback) {
                  ...
                  window.mqq.invoke('data', 'setShareInfo', {
                    ...
                    return window.mqq.ui.setOnShareHandler(function (type) {
                      var sinfo = master.shareInfo; // !master.browser.os.android?
                      ...
                      mqq.ui.shareMessage({
                        ...
                        return master.shareCallback(data, ['qq', 'qzone', 'weixin', 'timeLine'][type]);
                      }); // : shareLinkAux(
                      //       type,
                ...
                share2qq: function share2qq(_) {
                  return master.shareInfo.type === 'base64' ? shareImgAux('0', 'qq') : shareLinkAux('toQQ', 'qq');
                },
                share2qz: function share2qz(_) {
                  return master.shareInfo.type === 'base64' ? shareImgAux('1', 'qzone') : shareLinkAux('toQz', 'qzone');
                },
                share2wx: function share2wx(_) {
                  return master.shareInfo.type === 'base64' ? shareImgAux('2', 'weixin') : shareLinkAux('toWX', 'weixin');
                },
                share2timeLine: function share2timeLine(_) {
                  return master.shareInfo.type === 'base64' ? shareImgAux('3', 'timeLine') : shareLinkAux('toTL', 'timeLine');
                }
              });
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/helpers/extends */ "./node_modules/@babel/runtime/helpers/extends.js"), __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! ../util/toggleClass */ "./src/util/toggleClass.js"), __webpack_require__(/*! ../util/uuid */ "./src/util/uuid.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _extends2, _classCallCheck2, _createClass2, _toggleClass, _uuid) {
  "use strict";
  ...
  var _default = function _default(master, opts) {
    ...
    function () {
      function UI() {
        ...
        this.state = (0, _extends2.default)(oldState, opts.uiState);
      ...
      (0, _createClass2.default)(UI, [{
        ...
        value: function renderToHtml() {
          var _t = this.state;
          return "\n            <link media=\"all\" rel=\"stylesheet\" href=\"//qzs.qzone.qq.com/qz-proj/weishi-mobile/mod-pop-share.css\">\n              <link media=\"all\" rel=\"stylesheet\" href=\"//qzs.qzone.qq.com/qz-proj/weishi-mobile/mod-tip-mask.css\">\n            <div class=\"pop pop-share show\" id=\"pop-share-".concat(uuid, "\">\n                <div class=\"mod-box\">\n                    ").concat(_t.isPreview ? "\n                    <div class=\"box-hd\">\n                        <h4 class=\"tit\">\n                            ".concat(_t.shareInfo.link && _t.isSupportBase64 ? _t.copy.chooseShare : '', "\n                        </h4>\n                        <button class=\"btn-close\">\n                            <i style=\"overflow:visible\" class=\"icon icon-close icon-share-close\" id=\"icon-share-close-").concat(uuid, "\"></i>\n                        </button>\n                    </div>\n                    <div class=\"box-bd\">\n                        <ul class=\"type-list\">\n\n                            ").concat(_t.isSupportBase64 ? "\n                            <li class=\"type-item ".concat(_t.type ? 'act' : '', "\" id=\"tx-share-option-1-").concat(uuid, "\">\n                                <h5 class=\"type-tit\">").concat(_t.copy.shareImage, "</h5>\n                                <div class=\"share-card-wrap\">\n                                    <img src=\"").concat(_t.shareInfo.base64, "\" style=\"width:100%\" />\n                                </div>\n                                ").concat(_t.shareInfo.link ? "<i style=\"overflow:visible\" class=\"icon icon-check\"></i>" : '', "\n                            </li>") : "", "\n\n                            ").concat(_t.shareInfo.link ? "<li class = \"type-item ".concat(_t.isSupportBase64 && !_t.type ? 'act' : '', " \"\n                            id = \"tx-share-option-2-").concat(uuid, "\" >\n                                <h5 class=\"type-tit\">").concat(_t.copy.shareLink, "</h5>\n                                <div class=\"share-link-wrap\">\n                                    <div class=\"pic\" style=\"background-image:url(").concat(_t.shareInfo.imgUrl, ")\"></div>\n                                    <p class=\"txt\">").concat(_t.shareInfo.desc, "</p>\n                                </div>\n                                ").concat(_t.shareInfo.link && _t.isSupportBase64 ? "<i style=\"overflow:visible\" class=\"icon icon-check\"></i>" : '', "\n                            </li>") : '', "\n\n                        </ul>\n                    </div>") : '', "\n                    <div class=\"box-ft\">\n                        <h4 class=\"tit\">\n                            <span>\u5206\u4EAB\u5230</span>\n                            ").concat(!_t.isPreview ? "\n                            <button class=\"btn-close\">\n                            <i style=\"overflow:visible\" class=\"icon icon-close icon-share-close\" id=\"icon-share-close-".concat(uuid, "\"></i>\n                            </button>") : '', "\n                        </h4>\n                        <ul class=\"share-list\">\n                            ").concat(_t.shareConfig.qq ? "\n                            <li class=\"share-item\">\n                                <i style=\"overflow:visible\" class=\"icon icon-share-qq\" id=\"icon-share-qq-".concat(uuid, "\"></i>\n                                <span class=\"txt\">QQ</span>\n                            </li>") : '', "\n                            ").concat(_t.shareConfig.qz ? "\n                            <li class=\"share-item\">\n                                <i style=\"overflow:visible\" class=\"icon icon-share-qz\" id=\"icon-share-qz-".concat(uuid, "\"></i>\n                                <span class=\"txt\">QQ\u7A7A\u95F4</span>\n                            </li>") : '', "\n                        ").concat(_t.shareConfig.wx ? "\n                            <li class=\"share-item\">\n                                <i style=\"overflow:visible\" class=\"icon icon-share-wx\" id=\"icon-share-wx-".concat(uuid, "\"></i>\n                                <span class=\"txt\">\u5FAE\u4FE1</span>\n                            </li>") : '', "\n                        ").concat(_t.shareConfig.timeLine ? "\n                            <li class=\"share-item\">\n                                <i style=\"overflow:visible\" class=\"icon icon-share-pyq\" id=\"icon-share-pyq-".concat(uuid, "\"></i>\n                                <span class=\"txt\">\u670B\u53CB\u5708</span>\n                            </li>") : '', "\n                            ").concat(_t.shareConfig.weibo ? "\n                            <li class=\"share-item\">\n                                <i style=\"overflow:visible\" class=\"icon icon-share-wb\" id=\"icon-share-wb-".concat(uuid, "\"></i>\n                                <span class=\"txt\">\u5FAE\u535A</span>\n                            </li>") : '', "\n                        </ul>\n                    </div>\n                </div>\n            </div>");
        }
      }, {
        key: "appendMaskDom",
        ...
        value: function getMountDom() {
          var mountDom = document.getElementById(this.mountId);

          if (!mountDom) {
            ;
            (console.error || console.log)('MoundID:', this.mountId, 'is not found!');
            return null;
          }
        ...
        value: function openMask() {
          var overMask = document.getElementById(this.maskMountId);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function () {
    ...
    _regenerator.default.mark(function _callee3(master) {
      var hasQrCodeShow, openit, showQRcode;
      return _regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              showQRcode = function showQRcode(imgrul) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var self = {
    ...
    compareWSVersion: function compareWSVersion(target, cmd) {
      ...
      var _compare = function _compare(tokens1, tokens2, p) {
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              shareLinkAux = function shareLinkAux(sinfo, cmd, source) {
                window.mqq.invoke('share', cmd, {
                  type: 'url',
                  title: sinfo.title,
                  imgUrl: sinfo.imgUrl,
              ...
              shareImgWxAux = function shareImgWxAux(sinfo, cmd, source) {
              ...
              shareImgQQAux = function shareImgQQAux(sinfo, cmd, source) {
                return window.mqq.invoke('share', cmd, {
                  type: 'image',
                  content: sinfo.base64,
              ...
              (0, _overWrite.default)(master.api, {
                ...
                setShareInfo: function setShareInfo(s, callback, fix) {
                  if (!(master.ui.state && master.ui.state.disableWSCustomBtn)) return craetShareButton(master); //&& !self.compareWSVersion('5.6.0', 'gt')
                  ...
                  window.mqq.invoke('data', 'setShareInfo', {
                    ...
                    if (window.mqq.share) {
                      window.mqq.share.setOnShareHandler(function (type) {
                ...
                share2qq: function share2qq(_) {
                  return master.shareInfo.type === 'base64' ? shareImgQQAux(master.shareInfo, 'shareQQ', 'qq') : shareLinkAux(master.shareInfo, 'shareQQ', 'qq');
                },
                share2wx: function share2wx(_) {
                  return master.shareInfo.type === 'base64' ? shareImgWxAux(master.shareInfo, 'shareAppMessage', 'weixin') : shareLinkAux(master.shareInfo, 'shareAppMessage', 'weixin');
                },
                share2qz: function share2qz(_) {
                  return master.shareInfo.type === 'base64' ? shareImgQQAux(master.shareInfo, 'shareQZone', 'qzone') : shareLinkAux(master.shareInfo, 'shareQZone', 'qzone');
                },
                share2timeLine: function share2timeLine(_) {
                  return master.shareInfo.type === 'base64' ? shareImgWxAux(master.shareInfo, 'shareTimeline', 'timeLine') : shareLinkAux(master.shareInfo, 'shareTimeline', 'timeLine');
                }
              });
          ...
          switch (_context3.prev = _context3.next) {
                ...
                _regenerator.default.mark(function _callee() {
                  return _regenerator.default.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          if (!("function" == 'function' && (__webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") || __webpack_require__(/*! !webpack amd define */ "./node_modules/webpack/buildin/amd-define.js").cmd) && window.seajs)) {
                            _context.next = 4;
                            break;
                          }
            ...
            case 9:
              common = function common(s, callback) {
                ...
                var wsinfo = function wsinfo(source) {
                  return {
                    title: master.shareInfo.title,
                    desc: master.shareInfo.desc,
                    link: master.shareInfo.link,
                    ...
                    success: function success(_) {
                      return master.shareCallback(_, source);
                    },
...
//# sourceMappingURL=tx-share.js.map